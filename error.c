 ...
 * Copyright (C) 1990-1998, 2000-2007, 2009-2012 Free Software Foundation
...
#if (!defined(_LIBC) || !_LIBC) && (defined(ENABLE_NLS) && ENABLE_NLS)
# include "gettext.h"
...
# else
   ...
   * and the fd of a FILE stream is stored as a field in its allocated
   * memory: */
...
#if defined(HAVE_STRERROR_R) || (defined(_LIBC) && _LIBC)
  char errbuf[1024];
